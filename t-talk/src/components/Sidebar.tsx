...
export default function Sidebar({
  page,
  setPage,
  unreadNotificationsCount = 2, // Valor estatico para simular notificaciones
}: Props) {
  const items = [
    {
      id: "home",
            ...
            {items.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {item.badge && !isActive && (
                    <span className="bg-emerald-500 text-white text-[11px] font-bold px-2 py-0.5 rounded-full shadow-sm min-w-[18px] text-center">
                      {item.badge}
                    </span>
                  )}
                </button>
