export default function Signup() {
  return (
    <div className="min-h-screen bg-[#f5efe6] flex items-center justify-center px-4 overflow-hidden relative">
      ...
      {/* blobs */}
      <div className="absolute w-[500px] h-[500px] bg-[#e7c6a5] rounded-full blur-[120px] top-[-100px] right-[-100px] opacity-70"></div>

      <div className="absolute w-[350px] h-[350px] bg-[#d6b49f] rounded-full blur-[100px] bottom-[-80px] left-[-80px] opacity-60"></div>
      ...
      <div className="relative z-10 w-full max-w-5xl rounded-[40px] overflow-hidden border border-white/30 shadow-[0_8px_32px_rgba(0,0,0,0.08)] bg-white/30 backdrop-blur-2xl grid md:grid-cols-2">
        ...
        >
          ...
          >
            ...
            {/* textura de líneas finas tipo tela/material */}
            ...
            {/* sombra izquierda oscura violácea */}
            <path
            ...
            {/* forma orgánica principal naranja — «ola» desde esquina derecha */}
            <path
              d="
                M500,0
            ...
            {/* segunda curva suave — da volumen entre oscuro y naranja */}
            <path
              d="
                M500,0
            ...
            {/* línea de borde luminosa — rim light sutil */}
            <path
              d="
                M500,5
        ...
        <div className="p-12 flex flex-col justify-center">
          ...
          <p className="text-[#8b7355] font-semibold mb-3 tracking-wide">
            Empieza ahora
          </p>

          <h1 className="text-5xl font-black text-[#2d2d2d] mb-8">
            Crear cuenta
          </h1>
          ...
          <input
            type="text"
            placeholder="Nombre"
            className="w-full mb-4 px-5 py-4 rounded-2xl bg-white/40 border border-white/40 outline-none text-gray-800 placeholder:text-gray-500"
          />
          ...
          <input
            ...
            className="w-full mb-6 px-5 py-4 rounded-2xl bg-white/40 border border-white/40 outline-none text-gray-800 placeholder:text-gray-500"
          />
          ...
          <a
            href="/login"
            className="text-center mt-5 font-semibold text-[#8b7355] hover:opacity-70"
          >
            Ya tengo cuenta
          </a>
        </div>
